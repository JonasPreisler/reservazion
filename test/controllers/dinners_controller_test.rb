...
class DinnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dinner" do
    assert_difference('Dinner.count') do
      post dinners_url, params: { dinner: { ends_at: @dinner.ends_at, starts_at: @dinner.starts_at } }
    end
  ...
  test "should update dinner" do
    patch dinner_url(@dinner), params: { dinner: { ends_at: @dinner.ends_at, starts_at: @dinner.starts_at } }
